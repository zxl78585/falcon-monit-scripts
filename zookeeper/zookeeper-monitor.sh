...
# 共享参数
endpoint="213-zookeeper"
falconserver="10.3.0.3"
# 获取数据
...
function upload() {
curl -X POST -H "Accept: application/json" -H "Content-Type: application/json" http://${falconserver}:1988/v1/push -vv --data @<(cat <<EOF
[{
